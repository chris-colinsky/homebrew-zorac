class Zorac < Formula
  ...
  homepage "https://github.com/chris-colinsky/chris-colinsky/zorac"
  ...
  def install
    ...
    # We install the package normally. Pip handles the dependencies (like dotenv).
